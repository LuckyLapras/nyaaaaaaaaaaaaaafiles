let g:airline#themes#base16_lily#palette = {}

function! airline#themes#base16_lily#refresh()
  ...
  let g:airline#themes#base16_lily#palette.normal
        \ = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
  let g:airline#themes#base16_lily#palette.normal_modified = {
  ...
  let g:airline#themes#base16_lily#palette.insert
  ...
  let g:airline#themes#base16_lily#palette.insert_modified
        \ = copy(g:airline#themes#base16_vim#palette.normal_modified)

  " Replace mode
  let s:R1 = [s:gui01, s:gui08, s:base01, s:base0C]
  let s:R3 = [s:gui08, s:gui01, s:base0C, s:base01]
  let g:airline#themes#base16_lily#palette.replace
  ...
  let g:airline#themes#base16_lily#palette.replace_modified
        \ = copy(g:airline#themes#base16_vim#palette.normal_modified)

  " Visual mode
  let s:V1 = [s:gui01, s:gui0E, s:base01, s:base0E]
  let s:V3 = [s:gui0E, s:gui01, s:base0E, s:base01]
  let g:airline#themes#base16_lily#palette.visual
  ...
  let g:airline#themes#base16_lily#palette.inactive
        \ = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
  let g:airline#themes#base16_lily#palette.inactive_modified = {
        \ 'airline_c': [s:gui09, '', s:base09, '', ''],
        \ }
endfunction

call airline#themes#base16_lily#refresh()
