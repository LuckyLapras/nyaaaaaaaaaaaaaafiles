...
--              {description = "show the menubar", group = "launcher"})
    awful.key({ modkey }, "d", function() awful.util.spawn_with_shell("$HOME/.config/polybar/shades/scripts/launcher.sh")
    end,
              {description = "open launcher", group = "awesome"}),
    awful.key({}, "Print", function() awful.util.spawn_with_shell("$HOME/.scripts/screenshot.sh -q") end,
              {description = "cum", group = "cum"}),
    awful.key({ "Control" }, "Print", function() awful.util.spawn_with_shell("$HOME/.scripts/screenshot.sh -s") end,
              {description = "cum", group = "cum"}),
    awful.key({ "Control", "Shift" }, "Print", function() awful.util.spawn_with_shell("$HOME/.scripts/screenshot.sh -w") end,
              {description = "cum", group = "cum"})
)
